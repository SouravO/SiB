-- =====================================================
-- COMPLETE COURSES SETUP SCRIPT
-- =====================================================
-- This script will:
-- 1. Drop existing tables (if any)
-- 2. Create fresh courses and college_courses tables
...
-- 4. Copy ALL this content and paste
-- 5. Click "Run"
-- =====================================================
...
-- =====================================================
-- INSERT ALL 50 COURSES FROM courses.json
-- =====================================================
INSERT INTO courses (id, name, slug, category, degree, duration_years) VALUES
  ...
  ('09', 'B.Tech Electronics & Communication', 'btech-electronics-communication', 'Engineering', 'B.Tech', 4),
  ...
  ('12', 'B.Tech Electrical & Electronics', 'btech-electrical-electronics', 'Engineering', 'B.Tech', 4),
  ...
  ('15', 'B.Tech AI & Machine Learning', 'btech-ai-machine-learning', 'Engineering', 'B.Tech', 4),
  ('16', 'B.Tech Data Science', 'btech-data-science', 'Engineering', 'B.Tech', 4),
  ('17', 'B.E Computer Science (AI & ML)', 'be-computer-science-ai-ml', 'Engineering', 'B.E', 4),
  ('18', 'M.Tech', 'mtech', 'Engineering', 'M.Tech', 2),
  ('19', 'M.E', 'me', 'Engineering', 'M.E', 2),
  ('20', 'Diploma in Engineering', 'diploma-engineering', 'Engineering', 'Diploma', 3),
...
-- =====================================================
-- VERIFICATION - Check if courses were inserted
-- =====================================================
